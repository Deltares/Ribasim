...
echo "Downloading QGIS setup scripts (not included in qgis/qgis:3.40 image)"
...
docker exec -t qgis sh -c "apt install -y python3-pandas python3-pytest python3-coverage python3-netcdf4"
