...
#   timestamp: 2023-08-23T11:30:03+00:00
...
class IntervalControlCondition(BaseModel):
    remarks: Optional[str] = Field("", description="a hack for pandera")
...
class IntervalControlLogic(BaseModel):
    remarks: Optional[str] = Field("", description="a hack for pandera")
...
class Root(BaseModel):
    ...
    IntervalControlCondition: Optional[IntervalControlCondition] = None
    ...
    IntervalControlLogic: Optional[IntervalControlLogic] = None
