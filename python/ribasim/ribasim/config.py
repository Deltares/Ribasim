...
from ribasim.schemas import (  # type: ignore
    AllocationLevelControlStaticSchema,
...
class AllocationLevelControl(NodeModel):
    static: TableModel[AllocationLevelControlStaticSchema] = Field(
        default_factory=TableModel[AllocationLevelControlStaticSchema],
        json_schema_extra={"sort_keys": ["node_id", "priority"]},
    )
    time: TableModel[AllocationLevelControlTimeSchema] = Field(
        default_factory=TableModel[AllocationLevelControlTimeSchema],
        json_schema_extra={"sort_keys": ["node_id", "priority", "time"]},
    )
