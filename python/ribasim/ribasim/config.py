...
#   timestamp: 2023-09-12T09:11:45+00:00
...
class Output(BaseModel):
    compression: Optional[str] = Field("zstd", description="compression")
...
class Solver(BaseModel):
    ...
    saveat: Optional[Union[List[float], float]] = Field([], description="saveat")
