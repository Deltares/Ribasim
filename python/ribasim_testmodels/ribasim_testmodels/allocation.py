...
def medium_primary_secondary_network_verification_model() -> Model:
    ...
    model.level_demand.add(
        Node(18, Point(2.5, -0.5), subnetwork_id=2),
        [level_demand.Static(min_level=[0.5], max_level=[0.5], demand_priority=1)],
    )
    ...
    model.level_demand.add(
        Node(20, Point(4, 2), subnetwork_id=2),
        [level_demand.Static(min_level=[0.5], max_level=[0.5], demand_priority=2)],
    )
    ...
    # outlet towards second basin
    model.outlet.add(
        Node(4, Point(1.5, 0), subnetwork_id=2),
        [outlet_data],
    )

    # second basin
    model.basin.add(Node(5, Point(2, 0), subnetwork_id=2), basin_data)
    ...
    # outlet towards fourth basin
    model.outlet.add(
        Node(16, Point(2.5, 0), subnetwork_id=2),
        [outlet_data],
    )

    # third basin
    model.basin.add(Node(7, Point(3, 0), subnetwork_id=2), basin_data)

    # outlet towards second subnetwork
    model.outlet.add(
        Node(8, Point(3, 1), subnetwork_id=2),
        [outlet_data],
    )

    # outlet towards fourth basin
    model.outlet.add(
        Node(9, Point(3.5, 0), subnetwork_id=2),
        [outlet_data],
    )

    # fourth basin
    model.basin.add(Node(10, Point(4, 0), subnetwork_id=2), basin_data)

    # outlet towards second subnetwork
    model.outlet.add(Node(11, Point(4, 1), subnetwork_id=2), [outlet_data])
    ...
    ################################# begin subnetwork 3 ####################################
    model.basin.add(Node(15, Point(3.5, 1.5), subnetwork_id=2), basin_data)
    model.user_demand.add(
