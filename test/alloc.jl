...
@testset "allocation_V" begin
    ...
    demand = Ribasim.savedvalues(reg, :usersys_151358₊demand)
    alloc = Ribasim.savedvalues(reg, :usersys_151358₊alloc)
    abs = Ribasim.savedvalues(reg, :usersys_151358₊abs)
    area = Ribasim.savedvalues(reg, :lsw_151358₊area)
...
@testset "allocation_P" begin
    ...
    demand = Ribasim.savedvalues(reg, :usersys_200164₊demand)
    alloc_a = Ribasim.savedvalues(reg, :usersys_200164₊alloc_a)
    alloc_b = Ribasim.savedvalues(reg, :usersys_200164₊alloc_b)
    abs = Ribasim.savedvalues(reg, :usersys_200164₊abs)
    area = Ribasim.savedvalues(reg, :lsw_200164₊area)
    P = Ribasim.savedvalues(reg, :lsw_200164₊P)
    E_pot = Ribasim.savedvalues(reg, :lsw_200164₊E_pot)
    S = Ribasim.savedvalues(reg, :lsw_200164₊S)
    drainage = Ribasim.savedvalues(reg, :lsw_200164₊drainage)
    infiltration = Ribasim.savedvalues(reg, :lsw_200164₊infiltration)
    urban_runoff = Ribasim.savedvalues(reg, :lsw_200164₊urban_runoff)
