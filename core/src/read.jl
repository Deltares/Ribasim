...
function LinearResistance(db, config, graph)
    static = load_structvector(db, config, :linear_resistance, :static)
...
function TabulatedRatingCurve(db::DB, config::Config, graph::MetaGraph)
    static = load_structvector(db, config, :tabulated_rating_curve, :static)
    time = load_structvector(db, config, :tabulated_rating_curve, :time)
...
function ManningResistance(db::DB, config::Config, graph::MetaGraph, basin::Basin)
    static = load_structvector(db, config, :manning_resistance, :static)
...
function LevelBoundary(db::DB, config::Config)
    static = load_structvector(db, config, :level_boundary, :static)
    time = load_structvector(db, config, :level_boundary, :time)
    concentration_time = load_structvector(db, config, :level_boundary, :concentration)
...
function FlowBoundary(db::DB, config::Config, graph::MetaGraph)
    static = load_structvector(db, config, :flow_boundary, :static)
    time = load_structvector(db, config, :flow_boundary, :time)
    concentration_time = load_structvector(db, config, :flow_boundary, :concentration)
...
function Pump(db::DB, config::Config, graph::MetaGraph)
    static = load_structvector(db, config, :pump, :static)
    time = load_structvector(db, config, :pump, :time)
...
function Outlet(db::DB, config::Config, graph::MetaGraph)
    static = load_structvector(db, config, :outlet, :static)
    time = load_structvector(db, config, :outlet, :time)
...
function ConcentrationData(
    ...
    concentration_state_data = load_structvector(db, config, :basin, :concentration_state)
...
function Basin(db::DB, config::Config, graph::MetaGraph)::Basin
    static = load_structvector(db, config, :basin, :static)
    time = load_structvector(db, config, :basin, :time)
    state = load_structvector(db, config, :basin, :state)
    concentration_time = load_structvector(db, config, :basin, :concentration)
    ...
    profiles = load_structvector(db, config, :basin, :profile)
...
function parse_variables_and_conditions(ids::Vector{Int32}, db::DB, config::Config)
    condition = load_structvector(db, config, :discrete_control, :condition)
    compound_variable = load_structvector(db, config, :discrete_control, :variable)
...
function continuous_control_functions(db, config, ids)
    ...
    func = load_structvector(db, config, :continuous_control, :function)
    errors = false
...
function continuous_control_compound_variables(db::DB, config::Config, ids)
    ...
    data = load_structvector(db, config, :continuous_control, :variable)
...
function ContinuousControl(db::DB, config::Config)::ContinuousControl
    compound_variable = load_structvector(db, config, :continuous_control, :variable)
...
function PidControl(db::DB, config::Config)
    static = load_structvector(db, config, :pid_control, :static)
    time = load_structvector(db, config, :pid_control, :time)
...
function UserDemand(db::DB, config::Config, graph::MetaGraph)
    static = load_structvector(db, config, :user_demand, :static)
    time = load_structvector(db, config, :user_demand, :time)
    concentration_time = load_structvector(db, config, :user_demand, :concentration)
...
function LevelDemand(db::DB, config::Config, graph::MetaGraph)
    static = load_structvector(db, config, :level_demand, :static)
    time = load_structvector(db, config, :level_demand, :time)
...
function FlowDemand(db::DB, config::Config)
    static = load_structvector(db, config, :flow_demand, :static)
    time = load_structvector(db, config, :flow_demand, :time)
...
function Subgrid(db::DB, config::Config, basin::Basin)
    static = load_structvector(db, config, :basin, :subgrid)
    time = load_structvector(db, config, :basin, :subgrid_time)
    cyclic_times = get_cyclic_time(db, "Basin")
...
function interpolate_basin_profile!(basin::Basin, profiles::StructVector)
