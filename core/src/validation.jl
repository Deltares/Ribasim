...
n_neighbor_bounds_flow(::Val{:linear_resistance}) = n_neighbor_bounds(1, 1, 1, 1)
n_neighbor_bounds_flow(::Val{:manning_resistance}) = n_neighbor_bounds(1, 1, 1, 1)
n_neighbor_bounds_flow(::Val{:tabulated_rating_curve}) = n_neighbor_bounds(1, 1, 1, 1)
n_neighbor_bounds_flow(::Val{:level_boundary}) =
    n_neighbor_bounds(0, typemax(Int), 0, typemax(Int))
n_neighbor_bounds_flow(::Val{:flow_boundary}) = n_neighbor_bounds(0, 0, 1, 1)
...
n_neighbor_bounds_flow(::Val{:pid_control}) = n_neighbor_bounds(0, 0, 0, 0)
n_neighbor_bounds_flow(::Val{:continuous_control}) = n_neighbor_bounds(0, 0, 0, 0)
n_neighbor_bounds_flow(::Val{:discrete_control}) = n_neighbor_bounds(0, 0, 0, 0)
n_neighbor_bounds_flow(::Val{:user_demand}) = n_neighbor_bounds(1, 1, 1, 1)
n_neighbor_bounds_flow(::Val{:level_demand}) = n_neighbor_bounds(0, 0, 0, 0)
n_neighbor_bounds_flow(::Val{:flow_demand}) = n_neighbor_bounds(0, 0, 0, 0)
...
n_neighbor_bounds_control(::Val{:linear_resistance}) = n_neighbor_bounds(0, 1, 0, 0)
n_neighbor_bounds_control(::Val{:manning_resistance}) = n_neighbor_bounds(0, 1, 0, 0)
n_neighbor_bounds_control(::Val{:tabulated_rating_curve}) = n_neighbor_bounds(0, 1, 0, 0)
n_neighbor_bounds_control(::Val{:level_boundary}) = n_neighbor_bounds(0, 0, 0, 0)
n_neighbor_bounds_control(::Val{:flow_boundary}) = n_neighbor_bounds(0, 0, 0, 0)
...
n_neighbor_bounds_control(::Val{:pid_control}) = n_neighbor_bounds(0, 1, 1, 1)
n_neighbor_bounds_control(::Val{:continuous_control}) =
    n_neighbor_bounds(0, 0, 1, typemax(Int))
n_neighbor_bounds_control(::Val{:discrete_control}) =
    n_neighbor_bounds(0, 0, 1, typemax(Int))
n_neighbor_bounds_control(::Val{:user_demand}) = n_neighbor_bounds(0, 0, 0, 0)
n_neighbor_bounds_control(::Val{:level_demand}) = n_neighbor_bounds(0, 0, 1, typemax(Int))
n_neighbor_bounds_control(::Val{:flow_demand}) = n_neighbor_bounds(0, 0, 1, 1)
...
controllablefields(::Val{:linear_resistance}) = Set((:active, :resistance))
controllablefields(::Val{:manning_resistance}) = Set((:active, :manning_n))
controllablefields(::Val{:tabulated_rating_curve}) = Set((:active, :table))
controllablefields(::Val{:pump}) = Set((:active, :flow_rate))
controllablefields(::Val{:outlet}) = Set((:active, :flow_rate))
controllablefields(::Val{:pid_control}) =
