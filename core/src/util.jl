...
wrap_state(u_raw::AbstractVector, p_independent::ParametersIndependent) =
    CArrays.CArray(u_raw, p_independent.state_ranges)
...
"""
function check_new_input!(p::Parameters, u::AbstractVector, t::Number)::Nothing
