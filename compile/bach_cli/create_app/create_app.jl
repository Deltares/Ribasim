...
function add_metadata()
    ...
    # the Manifest.toml always gives the exact version of Bach that was built
    ...
    open(normpath(appdir, "README.md"), "a") do io
        # since the exact Bach version may be hard to find in the Manifest.toml file
        ...
        bach_entry = only(manifest["deps"]["Bach"])
        version = bach_entry["version"]
        repo = GitRepo("../../..")
        ...
        url = "https://github.com/Deltares/Bach.jl/tree"
        version_info = """
