...
If you also want to inject the concentrations as model input, call `parse(..., to_input=True)` to populate the `Basin / concentration_external` table in addition to writing the NetCDF file.
