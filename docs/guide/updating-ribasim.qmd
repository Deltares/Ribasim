...
To update the Ribasim installation itself, follow the [installation steps](/getting-started/install.qmd), ensuring that all installed components are the same.
