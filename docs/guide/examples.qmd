...
#| include: false
import Ribasim
Ribasim.main("data/basic/ribasim.toml")
```
...
#| include: false
import Ribasim
Ribasim.main("data/level_range/ribasim.toml")
```
...
#| include: false
import Ribasim
Ribasim.main("data/pid_control/ribasim.toml")
```
...
```{python}
model.experimental = Experimental(allocation=True)
model.allocation = Allocation(timestep=86400)
```
...
#| include: false
import Ribasim
Ribasim.main("data/allocation_example/ribasim.toml")
```
...
```{python}
model.experimental = Experimental(allocation=True)
model.allocation = Allocation(timestep=1e5)
```
...
#| include: false
import Ribasim
Ribasim.main("data/level_demand/ribasim.toml")
```
...
#| include: false
import Ribasim
Ribasim.main("data/local_pidcontrolled_cascade/ribasim.toml")
```
...
#| include: false
import Ribasim
Ribasim.main("data/outlet_continuous_control/ribasim.toml")
```
