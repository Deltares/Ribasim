...
# Create and validate the network schematization
...
- Add user demand nodes as appropriate and link them to the supplying Basin nodes.
...
- See the [reference documentation](/reference/usage.qmd) for details on units per table column.
