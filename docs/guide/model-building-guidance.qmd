---
title: "Incremental approach for building a Ribasim model"
--- 
...
Goal: create a valid network representation of the water system which runs and can be discussed with the stakeholder

Steps

- Discus with stakeholders the purpose of the model and what system components and behavior they want to see reflected in the model
...
# Phase 2: Improve model parameterization and assess behavior for semi-static conditions
...
# Phase 3: Improve model parameterization and assess behavior for dynamic boundary conditions
...
# Phase 4 (Optional): Introduce allocation
...
# Phase 5: Model validation and acceptance
