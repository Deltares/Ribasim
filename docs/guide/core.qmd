...
A more detailed sequence diagram of the simulation loop is available at the [core](../explanation/core.qmd#sec-simulationloop) home page.
...
During development these steps are normally done [on TeamCity](/explanation/ci.qmd#TeamCity),
