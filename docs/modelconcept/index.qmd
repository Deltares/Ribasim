---
title: Ribasim model concept
---
A brief summary of the conceptualization is given on the documentation [Home page](https://deltares.github.io/Ribasim/#sec-conceptualization)
...
we typically use the term "basin" to refer to the REW. Each basin has an associated polygon, and the set of basins is
...
TOP10NL [@pdoktopnl] in the Hupsel basin.
