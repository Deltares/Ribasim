...
The installation instructions can be found on their [web page](https://quarto.org/docs/download/).
...
In order to run the tests open the Julia REPL and execute the following command:
