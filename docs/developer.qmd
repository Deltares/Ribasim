...
The `bach_cli` is an executable that can be used without needing to install julia itself.
If you want to work from julia, but want to reduce the latency when working with Bach.jl,
an effective option is to work with system images. Like `bach_cli`, they can also be created
