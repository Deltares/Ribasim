...
This will download and install the latest version of Ribasim to `%USERPROFILE%\.ribasim` and automatically add it to your PATH.
...
The Ribasim QGIS plugin requires [QGIS](https://qgis.org/en/site/) 3.40 or 3.44, and the `pandas` package
in the QGIS Python environment (which is the case by default).
QGIS 4 support is experimental, the plotting pane may not work.
