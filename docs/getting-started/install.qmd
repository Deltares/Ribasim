...
executable is in the bin folder.
...
This will download and install the latest version of Ribasim to `%USERPROFILE%\.ribasim` and automatically add its `bin` directory to your PATH.
After installation, you can run `ribasim --help` from any directory.

It also sets the `RIBASIM_HOME` environment variable to `%USERPROFILE%\.ribasim`.
