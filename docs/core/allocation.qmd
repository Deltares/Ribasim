...
This type of objective cares about the absolute amount of water allocated to a demand. It treats all deviations equally which means it doesn't give larger punishment if deviations increase.
...
Likewise, the error of basin demands is the absolute value between flows consumed by basins and basin demands.
$$
