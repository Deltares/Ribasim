...
When preparing the model for simulation, input validation is performed in the Julia core. The validation rules are described in the [validation](validation.qmd) section.
...
-------------- | -------- | ---- | -----------
node_id        | Int      | -    | sorted
control_state  | String   | -    | sorted per node_id
