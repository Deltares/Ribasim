...
# autodiff can only be set for implicit solvers, where it defaults to true
# since autodiff is not yet supported, set it to false in this case.
autodiff = false  # optional, default not set
