...
Here $P$ is the precipitation rate and $A$ is the wetted area. $A$ is a
function of the storage $S$: as the volume of water changes, the area of the free water
...
$$
Q_E = E_\text{pot} \cdot A(S) \cdot \frac{1}{2}\left( \tanh\left(\frac{S-50}{10}\right) +1\right)
$$

Here $E_\text{pot}$ is the potential evaporation rate and $A$ is the wetted area.
The $\frac{1}{2}\left( \tanh\left(\frac{S-50}{10}\right) +1\right)$ term ensures almost no evaporation occurs
when $S \le 0$ and is a sigmoid function which provides a smooth gradient as $S
\rightarrow 0$.
...
$$
Q_\text{user} = Q_\text{alloc} \cdot \frac{1}{2}\left( \tanh\left(\frac{S-50}{10}\right) +1\right)
$$
