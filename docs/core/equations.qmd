...
We enforce the convention that when a pump is controlled its edge points away from the basin, and when a weir is controlled its edge points towards the basin. Therefore, positive flows of the pump and weir have opposite effects on the basin, and thus the parameters $K_p,K_i,K_d$ of the pump and weir must have oppositive signs to achieve the same goal.
