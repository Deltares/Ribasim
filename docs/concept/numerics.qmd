...
Consequently `abstol` does not scale with the size of the model, so it should not be raised
far above its default without checking the effect on small models.
