...
The above problem formulation gives us what we want: accurate storages and flows. However, if this problem is passed to an ODE-system as-is, this is rather computationally expensive due to the large number of states that are being solved for.

## The Jacobian

The Jacobian of the right hand side as formulated above is given by
...
AD backends can make clever use of caches to compute multiple of these JVPs at the same time, which saves several calls to $q$.
