...
For technical implementation details including how mathematical formulations translate to code, see the [Allocation Technical Reference](/dev/allocation-technical-reference.qmd).
:::
