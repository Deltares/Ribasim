...
:::{.callout-note}
For detailed technical documentation about the allocation implementation, including mathematical formulation to code mapping, see the [Allocation Technical Reference](/dev/allocation-technical-reference.qmd).
:::
...
The following sections provide detailed mathematical formulations and implementation specifications for developers working with the allocation system. For comprehensive technical documentation, see the [Allocation Technical Reference](/dev/allocation-technical-reference.qmd).
