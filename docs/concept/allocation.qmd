...
To use efficient linear programming algorithms, nonlinear relationships can be linearized around the current operating point by:
...
For example, a nonlinear relationship between flow $Q(S_1, S_2)$, upstream ($S_1$) and downstream ($S_2$) storage can be linearized as:
