...
::: {.callout-note}
**Subscript notation**: The subscript "fd" stands for "flow demand", indicating the specific priority level $p_{\text{fd}}$ associated with flow demand nodes in the subnetwork.
:::
