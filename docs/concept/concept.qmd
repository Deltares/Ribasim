...
An overview of node types and associated data inputs is provided on the [usage page](../reference/usage.qmd), while the associated mathematical formations are described on the [equations page](equations.qmd).
