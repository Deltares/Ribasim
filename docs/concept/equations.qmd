...
Here $u_\text{us}$ is the storage of the basin upstream of the pump or outlet, $\Phi$ is the product of [reduction factors](/concept/equations.qmd#sec-reduction_factor) associated with the [pump](/concept/equations.qmd#sec-pump) or [outlet](/concept/equations.qmd#sec-outlet) and
