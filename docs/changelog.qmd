...
- The Link table no longer supports `subnetwork_id`; this is automatically inferred. [#1956](https://github.com/Deltares/Ribasim/pull/1956)
...
The most significant breaking change is making the `node_id` and `link_id` the index of the Node and Link table; these need to be globally unique.
