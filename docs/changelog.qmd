...
- Solver setting `reduced_implicit_solve` (default `true`) to fall back to a less optimized but potentially more robust implicit solve. [#3150](https://github.com/Deltares/Ribasim/pull/3150)
