...
### Added
- BMI: Set FlowBoundary flow rates during a simulation and read cumulative flow for online coupling. [#3251](https://github.com/Deltares/Ribasim/pull/3251)
- Error on rapidly oscillating DiscreteControl states with the configurable `solver.min_discrete_control_interval`. [#3237](https://github.com/Deltares/Ribasim/pull/3237)
- Report rejected timesteps by cause and the mean solver order in `results/solver_stats.nc`. [#3269](https://github.com/Deltares/Ribasim/pull/3269)

### Changed
- The default solver is now NordsieckBDF. [#3236](https://github.com/Deltares/Ribasim/pull/3236)
- Solver tolerances now apply to changes over each timestep, including the nonlinear solver. [#3237](https://github.com/Deltares/Ribasim/pull/3237) [#3268](https://github.com/Deltares/Ribasim/pull/3268)
- The default absolute and relative solver tolerances are now both `1e-4`. [#3237](https://github.com/Deltares/Ribasim/pull/3237)
- In `results/solver_stats.nc`, `dt` is now the average timestep size over the output interval, and `rejected_timesteps` includes nonlinear solver failures. Convergence scores are now calculated per timestep, with bottlenecks logged after successful runs too. [#3253](https://github.com/Deltares/Ribasim/pull/3253) [#3269](https://github.com/Deltares/Ribasim/pull/3269)
- Allocation-controlled Pumps and Outlets require a finite `max_flow_rate`; those linking primary and secondary networks must explicitly set `allocation_controlled = true`. [#3259](https://github.com/Deltares/Ribasim/pull/3259)
- Large models initialize faster. [#3180](https://github.com/Deltares/Ribasim/pull/3180)
- Large models run 2-4x faster: the Jacobian is reused across Newton iterations and timesteps instead of being recomputed in every iteration, and Basin levels are computed from storage in closed form.

### Fixed
- Allocation: Fix route priorities, flow through controlled TabulatedRatingCurves when allocation is off, and several Junction and demand issues. [#3206](https://github.com/Deltares/Ribasim/pull/3206) [#3221](https://github.com/Deltares/Ribasim/pull/3221) [#3250](https://github.com/Deltares/Ribasim/pull/3250)
- Allocation: Improve LevelDemand stability for large Basins and consistency between single and multiple subnetworks. [#3246](https://github.com/Deltares/Ribasim/pull/3246)
- Provide actionable error diagnostics for unstable models, identifying affected nodes and physical flow rates. [#3242](https://github.com/Deltares/Ribasim/pull/3242) [#3267](https://github.com/Deltares/Ribasim/pull/3267) [#3272](https://github.com/Deltares/Ribasim/pull/3272) [#3273](https://github.com/Deltares/Ribasim/pull/3273)
- Invalid Pump, Outlet, and demand inputs now report parsing errors instead of failing silently or with misleading messages. [#3219](https://github.com/Deltares/Ribasim/pull/3219) [#3254](https://github.com/Deltares/Ribasim/pull/3254)
- Python: Removing an external table no longer leaves a missing-file reference in the model configuration. [#3214](https://github.com/Deltares/Ribasim/pull/3214)
- Delwaq: Reduce memory use when generating and parsing large results. [#3132](https://github.com/Deltares/Ribasim/pull/3132) [#3248](https://github.com/Deltares/Ribasim/pull/3248)

## [v2026.1.2] - 2026-06-16
...
### Added
- QGIS: Compare observed and simulated timeseries for Observation nodes in the plot widget. [#3115](https://github.com/Deltares/Ribasim/pull/3115)
- Python: Add `model.update_used_ids()` to refresh node and link ID counters after direct edits. [#3099](https://github.com/Deltares/Ribasim/pull/3099)
- Python: Make `NodeData` hashable, so nodes can be used in sets and as dictionary keys. [#3094](https://github.com/Deltares/Ribasim/pull/3094)
- QGIS guide: Add sections on spatial results and topology. [#3104](https://github.com/Deltares/Ribasim/pull/3104)

### Changed
- QGIS: Plot and guide improvements, including plotting flow rates on non-Basin nodes and unified legend labels. [#3102](https://github.com/Deltares/Ribasim/pull/3102)
- Delwaq: Drop required graph and substance state variables, so `generate` and `parse` can be run independently. [#3110](https://github.com/Deltares/Ribasim/pull/3110)
- Update to OrdinaryDiffEq v7. [#3082](https://github.com/Deltares/Ribasim/pull/3082)

### Fixed
- Delwaq: Allow for isolated Basin nodes. [#3088](https://github.com/Deltares/Ribasim/pull/3088)

### Removed
- The deprecated Ribasim core Windows installation script; use the installer or ZIP archive instead. [#3116](https://github.com/Deltares/Ribasim/pull/3116)

## [v2026.1.1] - 2026-05-09
...
### Added
- Support multiple inflow links for UserDemand. [#3035](https://github.com/Deltares/Ribasim/pull/3035)
- Adaptive timestepping for allocation. [#3026](https://github.com/Deltares/Ribasim/pull/3026)
- Add numerical documentation. [#2994](https://github.com/Deltares/Ribasim/pull/2994)

### Changed
- Improve order of tracers in plot/legend. [#3052](https://github.com/Deltares/Ribasim/pull/3052)
- Python: Speed up validation. [#3036](https://github.com/Deltares/Ribasim/pull/3036)
- Python: Speed up `add` API. [#3015](https://github.com/Deltares/Ribasim/pull/3015)
- Delwaq: Change system timer and verbosity control. [#3032](https://github.com/Deltares/Ribasim/pull/3032)
- `run_delwaq`: show stdout like `run_ribasim`. [#3027](https://github.com/Deltares/Ribasim/pull/3027)

### Fixed
- Fix allocation infeasibility reporting for some constraints. [#3078](https://github.com/Deltares/Ribasim/pull/3078)
- QGIS: More robust run cancellation. [#3077](https://github.com/Deltares/Ribasim/pull/3077)
- Delwaq: Remove boundary-boundary connections. [#3063](https://github.com/Deltares/Ribasim/pull/3063)
- Fix `starttime < endtime` validation. [#3059](https://github.com/Deltares/Ribasim/pull/3059)
- Fix wrongly reported intra-Junction flows. [#3054](https://github.com/Deltares/Ribasim/pull/3054)
- Fix allocation bug with allocation-controlled and flow demand node IDs. [#3044](https://github.com/Deltares/Ribasim/pull/3044)
- Filter missing data out of NetCDF. [#3033](https://github.com/Deltares/Ribasim/pull/3033)

## [v2026.1.0] - 2026-03-31
...
### Added
- Add `Basin / MassLoad` table. [#2990](https://github.com/Deltares/Ribasim/pull/2990)
- Add more `node_id` validation. [#2983](https://github.com/Deltares/Ribasim/pull/2983)
- QGIS: Support Junctions in fractional flow plot. [#3004](https://github.com/Deltares/Ribasim/pull/3004)

### Changed
- Support Pandas 3. [#3002](https://github.com/Deltares/Ribasim/pull/3002)
- Delwaq: don't plot from `concentration_external`. [#3007](https://github.com/Deltares/Ribasim/pull/3007)
- Replace, don't add to UserDemand tracer in UserDemand return flow. [#3009](https://github.com/Deltares/Ribasim/pull/3009)
- Provide `node_id` in Basin profile interpolation errors. [#2988](https://github.com/Deltares/Ribasim/pull/2988)

### Fixed
- Delwaq: Don't count removed Junctions in network generation. [#3001](https://github.com/Deltares/Ribasim/pull/3001)
- Don't load external NetCDF input in QGIS. [#2999](https://github.com/Deltares/Ribasim/pull/2999)
- Fix Jacobian state and time dependent cache bug. [#2972](https://github.com/Deltares/Ribasim/pull/2972)
- Allocation: Use  flow at `t` instead of cumulative flow divided by time. [#3000](https://github.com/Deltares/Ribasim/pull/3000)
- Remove dangling listen links. [#2978](https://github.com/Deltares/Ribasim/pull/2978)
- QGIS: Fix water balance plot storage. [#2975](https://github.com/Deltares/Ribasim/pull/2975)
- QGIS: Fix column order display. [#3005](https://github.com/Deltares/Ribasim/pull/3005)
- Add millisecond precision to fake `last_change`. [#2974](https://github.com/Deltares/Ribasim/pull/2974)
- Exclude UserDemand from default tracer set. [#3007](https://github.com/Deltares/Ribasim/pull/3007)

## [v2026.1.0-rc2] - 2026-03-06
...
### Added
- Add Observation node. [#2950](https://github.com/Deltares/Ribasim/pull/2950)
- Add implicit listen edges to Link table on write. [#2949](https://github.com/Deltares/Ribasim/pull/2949) [#2969](https://github.com/Deltares/Ribasim/pull/2969)
- Add a Boolean for allocation-controlled behavior. [#2912](https://github.com/Deltares/Ribasim/pull/2912)
- Add allocation-controlled TabulatedRatingCurve. [#2907](https://github.com/Deltares/Ribasim/pull/2907)
- Add guide for installing other Ribasim versions. [#2906](https://github.com/Deltares/Ribasim/pull/2906)
- Add VS Code guide. [#2857](https://github.com/Deltares/Ribasim/pull/2857)
- Add allocation technical reference documentation. [#2809](https://github.com/Deltares/Ribasim/pull/2809)
- Add section on debugging unexpected flow rates. [#2814](https://github.com/Deltares/Ribasim/pull/2814)
- QGIS: Add experimental QGIS 4 support. [#2960](https://github.com/Deltares/Ribasim/pull/2960)
- QGIS: Add configurable `RIBASIM_HOME`. [#2919](https://github.com/Deltares/Ribasim/pull/2919)
- QGIS: Support running Ribasim models. [#2881](https://github.com/Deltares/Ribasim/pull/2881)
- QGIS: Load external NetCDF input. [#2880](https://github.com/Deltares/Ribasim/pull/2880)
- QGIS: Add Plotly widget and NetCDF results support. [#2903](https://github.com/Deltares/Ribasim/pull/2903)
- QGIS: Add water balance plot. [#2939](https://github.com/Deltares/Ribasim/issues/2939)
- QGIS: Add fraction plotting. [#2968](https://github.com/Deltares/Ribasim/pull/2968)

### Changed
- Default to NetCDF for results storage. [#2855](https://github.com/Deltares/Ribasim/pull/2855)
- Complete writing remaining results to NetCDF. [#2856](https://github.com/Deltares/Ribasim/pull/2856)
- Remove Arrow support. [#2937](https://github.com/Deltares/Ribasim/pull/2937)
- Remove `model.to_fews`; add CF attributes to NetCDF input. [#2938](https://github.com/Deltares/Ribasim/pull/2938)
- Introduce Node table at Model level again. [#2886](https://github.com/Deltares/Ribasim/pull/2886)
- Use `RIBASIM_HOME` consistently in tooling and scripts. [#2891](https://github.com/Deltares/Ribasim/pull/2891)
- Set default interpolation behavior to block/constant. [#2909](https://github.com/Deltares/Ribasim/pull/2909) [#2896](https://github.com/Deltares/Ribasim/pull/2896)
- Set default basin route priority to `0`. [#2942](https://github.com/Deltares/Ribasim/pull/2942)
- Rename allocation output terminology from realized to supplied. [#2962](https://github.com/Deltares/Ribasim/pull/2962)
- Switch between control state and `ribasim.allocation`. [#2808](https://github.com/Deltares/Ribasim/pull/2808)
- Require QGIS 3.40 (LTR) or newer. [#2862](https://github.com/Deltares/Ribasim/pull/2862)
- Use new icons for `model.plot()` and docs. [#2917](https://github.com/Deltares/Ribasim/pull/2917) [#2916](https://github.com/Deltares/Ribasim/pull/2916)
- Keep external file paths in Python model handling. [#2943](https://github.com/Deltares/Ribasim/pull/2943)
- Add lazy reading and writing in Python. [#2878](https://github.com/Deltares/Ribasim/pull/2878)
- Remove migration warnings on model load. [#2826](https://github.com/Deltares/Ribasim/pull/2826)

### Fixed
- Handle allocation case with zero links. [#2959](https://github.com/Deltares/Ribasim/pull/2959)
- Fix default subnetwork ID to `1` in Julia core. [#2835](https://github.com/Deltares/Ribasim/pull/2835)
- Skip Junction in route-priority allocation problem building. [#2801](https://github.com/Deltares/Ribasim/pull/2801)

## [v2026.1.0-rc1] - 2025-12-23
...
The QGIS plugin is now published in the QGIS plugin repository and has a simplified UI; you can drag a TOML to QGIS to open a model.
The black screen in the iMOD plugin is fixed in the latest version of the iMOD plugin, and the Arrow errors on loading results are also fixed.
...
### Added
- Add `run_ribasim(toml_path)` convenience function. [#2653](https://github.com/Deltares/Ribasim/pull/2653)
- Allow replacing nodes with add API. [#2664](https://github.com/Deltares/Ribasim/pull/2664)
- Flow communication between primary and secondary networks. [#2556](https://github.com/Deltares/Ribasim/pull/2556)
- Read NetCDF files with demand_priority. [#2604](https://github.com/Deltares/Ribasim/pull/2604)
- Make reduction factor thresholds configurable. [#2592](https://github.com/Deltares/Ribasim/pull/2592) [#2681](https://github.com/Deltares/Ribasim/pull/2681)
- QGIS: Add menu and dropdown interface. [#2634](https://github.com/Deltares/Ribasim/pull/2634)
- Add docs on reloading model in QGIS plugin guide. [#2583](https://github.com/Deltares/Ribasim/pull/2583)
- Document `pandas` requirement for QGIS plugin. [#2642](https://github.com/Deltares/Ribasim/pull/2642)

### Changed
- Set `input_dir` default to "input". [#2641](https://github.com/Deltares/Ribasim/pull/2641)
- Python: Forbid any extra values in (base)model for stricter validation. [#2595](https://github.com/Deltares/Ribasim/pull/2595)
- Support Scientific Python SPEC 0 for broader compatibility. [#2630](https://github.com/Deltares/Ribasim/pull/2630)
- QGIS: Always use GDAL instead of pyarrow for better stability. [#2591](https://github.com/Deltares/Ribasim/pull/2591)
- Publish QGIS plugin. [#2654](https://github.com/Deltares/Ribasim/pull/2654) [#2658](https://github.com/Deltares/Ribasim/pull/2658)
- Improved build performance and compilation. [#2652](https://github.com/Deltares/Ribasim/pull/2652)

### Fixed
- Finalize progress bar. [#2665](https://github.com/Deltares/Ribasim/pull/2665)
- Fix Junctions with subnetwork ID. [#2633](https://github.com/Deltares/Ribasim/pull/2633)
- Delwaq: Restore correct water/mass balance with Junctions. [#2607](https://github.com/Deltares/Ribasim/pull/2607)
- Delwaq: Limit endtime for partially failed Ribasim runs. [#2637](https://github.com/Deltares/Ribasim/pull/2637)
- Delwaq: Improved performance of flow boundary concatenation. [#2597](https://github.com/Deltares/Ribasim/pull/2597)
- Fix remaining DelWAQ netCDF warnings. [#2621](https://github.com/Deltares/Ribasim/pull/2621)
- Fix DataInterpolations integration bug. [#2576](https://github.com/Deltares/Ribasim/pull/2576)
- QGIS: Fix empty Arrow results. [#2585](https://github.com/Deltares/Ribasim/pull/2585)
- Log clear error on decreasing area in `S(h)`. [#2600](https://github.com/Deltares/Ribasim/pull/2600)
- QGIS: Faster results drawing. [#2618](https://github.com/Deltares/Ribasim/pull/2618)
- QGIS: Fix crash on Reload Ribasim model. [#2661](https://github.com/Deltares/Ribasim/pull/2661)
- Reset `ribasim_version` in `model_post_init`. [#2578](https://github.com/Deltares/Ribasim/pull/2578)
- Convert Path to str with `.as_posix()` for cross-platform compatibility. [#2579](https://github.com/Deltares/Ribasim/pull/2579)
- Support pydantic 2.12. [#2650](https://github.com/Deltares/Ribasim/pull/2650)

## [v2025.5.0] - 2025-09-09
...
The [Ribasim Python installation section](https://ribasim.org/install.html#sec-install-python) allows you to pick your favorite package manager.
...
### Added
- Add `surface_runoff` to Basin fluxes. [#2402](https://github.com/Deltares/Ribasim/pull/2402)
- Support NetCDF results. [#2497](https://github.com/Deltares/Ribasim/pull/2497)
- Support NetCDF input. [#2542](https://github.com/Deltares/Ribasim/pull/2542)
- Add multithreading. [#2562](https://github.com/Deltares/Ribasim/pull/2562)
- Implement hysteresis on DiscreteControl. [#2564](https://github.com/Deltares/Ribasim/pull/2564)
- Add `FlowBoundary / area` polygons. [#2537](https://github.com/Deltares/Ribasim/pull/2537)
- Native multi-objective optimization in allocation. [#2522](https://github.com/Deltares/Ribasim/pull/2522)
- Add control by allocation functionality. [#2401](https://github.com/Deltares/Ribasim/pull/2401)
- FlowDemand supports multiple priorities. [#2500](https://github.com/Deltares/Ribasim/pull/2500)
- Report cause of infeasibility in allocation problems. [#2398](https://github.com/Deltares/Ribasim/pull/2398) [#2481](https://github.com/Deltares/Ribasim/pull/2481)
- Add `convergence` and `dt` to results for performance monitoring. [#2405](https://github.com/Deltares/Ribasim/pull/2405)
...
- Use FlowDemand demand as minimum Pump/Outlet flow when allocation is not active. [#2506](https://github.com/Deltares/Ribasim/pull/2506)
- Expand and improve LevelDemand functionality with absolute error handling. [#2386](https://github.com/Deltares/Ribasim/pull/2386) [#2515](https://github.com/Deltares/Ribasim/pull/2515)
- Allocation optimization with warm start for better performance. [#2466](https://github.com/Deltares/Ribasim/pull/2466)
- Scale storage and flow in allocation for numerical stability. [#2407](https://github.com/Deltares/Ribasim/pull/2407)
- Switch from UMFPACK to KLU sparse linear solver for performance. [#2391](https://github.com/Deltares/Ribasim/pull/2391)
- Use pandera v0.25, and revert using pyarrow dtypes. [#2450](https://github.com/Deltares/Ribasim/pull/2450)
- QGIS: remove editing features for simplified workflow. [#2472](https://github.com/Deltares/Ribasim/pull/2472)
- Use smooth interpolation of ContinuousControl and TabulatedRatingCurve functions. [#2446](https://github.com/Deltares/Ribasim/pull/2446) [#2458](https://github.com/Deltares/Ribasim/pull/2458)
- Use a Reynolds based threshold for the ManningResistance relaxed root [2544](https://github.com/Deltares/Ribasim/pull/2544)
- Demand nodes with timeseries now use block interpolation [2568](https://github.com/Deltares/Ribasim/pull/2568)

### Fixed
- Core model initialization speedup. [#2548](https://github.com/Deltares/Ribasim/pull/2548) [#2533](https://github.com/Deltares/Ribasim/pull/2533)
- Fix validation error on multiple incoming control links. [#2535](https://github.com/Deltares/Ribasim/pull/2535)
- Improve error message for DiscreteControl with no data. [#2540](https://github.com/Deltares/Ribasim/pull/2540)
- Make convergence finite to avoid numerical issues. [#2534](https://github.com/Deltares/Ribasim/pull/2534)
- Cache FlowDemand lookup to avoid expensive operations in `water_balance!`. [#2523](https://github.com/Deltares/Ribasim/pull/2523)
- Increase stacksize on Windows to 8 MB to prevent stack overflow. [#2546](https://github.com/Deltares/Ribasim/pull/2546)
- Align timestep allocated and realized results in `allocation.arrow`. [#2554](https://github.com/Deltares/Ribasim/pull/2554)
- Support GeoPandas 1.1. [#2547](https://github.com/Deltares/Ribasim/pull/2547)
...
- Time dependent `threshold_high` thresholds in DiscreteControl. [#2079](https://github.com/Deltares/Ribasim/pull/2079)
