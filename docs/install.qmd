...
To check whether the installation was performed successfully, open 'cmd' go to the path where the executable is for example 'C:\Ribasim9\ribasim_windows' and and type `ribasim` with no arguments in the command line.
