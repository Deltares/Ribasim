...
- Ribasim executable - Windows: [ribasim_windows.zip](https://github.com/Deltares/Ribasim/releases/download/v2025.5.0/ribasim_windows.zip)
- Ribasim executable - Linux: [ribasim_linux.zip](https://github.com/Deltares/Ribasim/releases/download/v2025.5.0/ribasim_linux.zip)
...
```sh
pip install --upgrade ribasim==2025.5.0
```
...
```sh
conda install -c conda-forge ribasim=2025.5.0
```
...
in the QGIS Python environment (which is the default case).
...
- QGIS plugin: [ribasim_qgis.zip](https://github.com/Deltares/Ribasim/releases/download/v2025.5.0/ribasim_qgis.zip).
