...
pixi add ribasim==2025.4.0 gh 7zip qgis

# Download latest Ribasim QGIS plugin.
pixi run gh release download v2025.4.0 --repo Deltares/Ribasim --clobber --pattern ribasim_qgis.zip
...
pixi run gh release download v2025.4.0 --repo Deltares/Ribasim --clobber --pattern ribasim_windows.zip
