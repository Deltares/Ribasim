---
title: "Ribasim-Modflow Demonstration"
---
...
MODFLOW6 model(s) to couple to Ribasim's basins. Per model, a path to the coupling
...
2. A coupled run where the MODFLOW6 stages are updated by the Ribasim coupler
process, but without Ribasim. This results in volumes of 0.0, so all MODFLOW6
