...
```
datamodel-codegen --use-title-as-name --use-double-quotes --disable-timestamp --use-default --input docs/schema/root.schema.json --output python/ribasim/ribasim/models.py
datamodel-codegen --use-title-as-name --use-double-quotes --disable-timestamp --use-default --input docs/schema/Config.schema.json --output python/ribasim/ribasim/config.py
```
