...
For [v2023.09.0](https://github.com/Deltares/Ribasim/releases/tag/v2023.09.0) I used the "Generate release notes" button, which I then manually edited to copy the most important changes for users to the top in the form of https://keepachangelog.com/en/1.0.0/.
...
Include a link to the release notes and assets, which is whatever https://github.com/Deltares/Ribasim/releases/latest resolves to at that time.
