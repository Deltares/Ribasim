...
4. Press {{< kbd Ctrl+Shift+P >}} (or {{< kbd Cmd+Shift+P >}} on macOS) and select `Dev Containers: Clone Repository in Container Volume`.

This will build the devcontainer image and start a new container with all the necessary dependencies. The build and install will take a few minutes to complete.
