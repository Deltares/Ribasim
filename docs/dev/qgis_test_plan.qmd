...
- Check output dialog: _Shows "The Ribasim simulation was canceled."_.
...
- Check multiple variables: _Plot updates to show all checked variables, grouped by unit, legend shows "variable — #node\_id"_.
