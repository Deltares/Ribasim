...
- Select the node layer, and make a subselection of nodes on the map: _Nodes are highlighted in yellow, including their edges_.
- Open the Edge attribute table: _The highlighted rows are those with a from/to node\_id that was selected_.
