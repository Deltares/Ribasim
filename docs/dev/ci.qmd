...
When proposing new changes to the code base a [pull request](https://docs.github.com/en/push-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests) is opened.
...
[Bad link](https://example.com/en/actions)
