...
- The example models constructed in `docs/getting-started/examples.qmd` should be extended with the new node type or a new example model with the new node type should be made.
