...
See [Equations](../explanation/equations.qmd#the-jacobian) for a mathematical description of the Jacobian.
...
- The `PidControl` node is a special case which is discussed in [equations](../explanation/equations.qmd#sec-PID).
