...
Obtaining the capacities of all the flow edges in subnetwork. Stored in a SparseArray object from JuMP called `capacities`

### Handling the connection between the main network and subnetworks
function find_subnetwork_connetions will find the edges from the main network to a subnetwo
