...
:::{.callout-note}
For comprehensive technical documentation bridging mathematical formulation to code implementation, see the [Allocation Technical Reference](allocation-technical-reference.qmd).
:::
...
For detailed mathematical formulations and code examples of how objective functions and constraints are implemented, see the [Allocation Technical Reference](allocation-technical-reference.qmd).
