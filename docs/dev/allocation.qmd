...
## Output data
Function `save_demands_and_allocations` saves the demand and the allocated value per demand node. And funtion `save_allocation_flows` saves the optimized flows over the edges in the subnetwork.
