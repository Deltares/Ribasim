...
detail in the [the MODFLOW coupling section](coupling-demo.qmd) of this documentation.
...
functions [@mtkevents]. In a coupled run, the exchanges with MODFLOW 6 are also
