...
The associated mathematical formations are described on the [Allocation page](./core/allocation.qmd). In case of large networks, a subdivision in a main network with sub networks is recommended. For more details see the
explanation of the [simulation loop](./core/index.qmd#sec-nestedallocation} at the Julia core home page.
