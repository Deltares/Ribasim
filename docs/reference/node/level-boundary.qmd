...
With this the levels can be updated over time. In between the given times
constant interpolation (forward fill) is used, and outside the given time range the level is kept constant at the
