...
The profile data is not detailed enough to create a full 3D picture of the basin. However, if we assume the profile data is for a stretch of canal of given length, we can use the following plot to get a mental picture of the basin. If you hover your cursor over the basin you see the corresponding level, area and storage.
