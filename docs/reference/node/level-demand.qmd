---
title: "![](https://s3.deltares.nl/ribasim/doc-image/node-icons/png/LevelDemand.png){width=30} LevelDemand"
---
...
node_id         | Int32    | -            |
time            | DateTime | -            |
min_level       | Float64  | $\text{m}$   | (optional)
max_level       | Float64  | $\text{m}$   | (optional)
demand_priority | Int32    | -            | positive (optional)
