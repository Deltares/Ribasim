---
title: "![](https://s3.deltares.nl/ribasim/doc-image/node-icons/png/Pump.png){width=30} Pump"
---
...
values are block interpolated (forward fill), and outside the values are constant given by the
nearest time value.
