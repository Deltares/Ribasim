...
flow rate is interpolated in a way specified in the [interpolation settings](../usage.qmd#interpolation-settings), and outside the flow rate is constant given by the
