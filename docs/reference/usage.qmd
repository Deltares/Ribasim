...
- `source_priority`: An integer per source type for the allocation algorithm. The available source types are: `user_demand`, `boundary`, `level_demand` and `flow_demand`.
