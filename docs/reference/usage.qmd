...
Apache Arrow is also supported for backward compatibility, but this format will be phased out
...
in separate files. **NetCDF is the recommended format for external table files**. This is
