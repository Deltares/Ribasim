...
If verbosity is set to debug, the used dimensions (level, area and storage) are written to a csv file in the results folder.

The format of the csv is: row 1 = node id, row 2 = level, row 3 = area and row 4 is storage.
