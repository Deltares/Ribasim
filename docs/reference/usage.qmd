...
# Run models needed for the documentation examples
from pathlib import Path

# Only run if results don't exist
if not Path("../../generated_testmodels/basic/results/basin.nc").exists():
    run_ribasim("../../generated_testmodels/basic/ribasim.toml")

if not Path("../../generated_testmodels/pump_discrete_control/results/control.nc").exists():
    run_ribasim("../../generated_testmodels/pump_discrete_control/ribasim.toml")

if not Path("../../generated_testmodels/flow_demand/results/allocation.nc").exists():
    run_ribasim("../../generated_testmodels/flow_demand/ribasim.toml")

if not Path("../../generated_testmodels/two_basin/results/subgrid_level.nc").exists():
    run_ribasim("../../generated_testmodels/two_basin/ribasim.toml")
```
