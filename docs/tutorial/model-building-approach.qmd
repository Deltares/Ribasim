...
The process to build a Ribasim model typically follows a phased approach.
...
- Add realistic flow boundary conditions and assess model behavior
- Extend the control rules to properly represent practice (including level and flow demands as deemed appropriate)
- Collect proper dynamic forcing (e.g. flow boundaries, user demands)
