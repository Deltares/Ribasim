...
The computational core is one of the components of Ribasim as illustrated in the [component overview](../tutorials/index.qmd#sec-components).
...
A more detailed sequence diagram of the simulation loop is available at the [core](../background/core.qmd#sec-simulationloop) home page.
...
During development these steps are normally done [on TeamCity](/background/ci.qmd#TeamCity),
