    ...
    init {
        ...
        steps {
            ...
            script {
                ...
                workingDir = "ribasim"
                scriptContent = """
                pixi run s3-upload "python/ribasim/ribasim/delwaq/model/test_offline_delwaq_coupling_evaporate_masscurrent/delwaq/delwaq_map.nc" "doc-image/delwaq/delwaq_map.nc"
                """.trimIndent()
            }
        }
    }
